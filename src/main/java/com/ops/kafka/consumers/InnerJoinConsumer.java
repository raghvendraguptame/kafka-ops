...
import static com.ops.kafka.config.Constants.STREAMS_INNER_JOIN_TOPIC;

public class InnerJoinConsumer {
  public static void main(String[] args) {
    ...
    try (KafkaConsumer<String, String> normalConsumer =
      ...
      normalConsumer.subscribe(Collections.singleton(STREAMS_INNER_JOIN_TOPIC));
      while (true) {
